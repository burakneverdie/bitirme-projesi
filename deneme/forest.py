...
from sklearn.ensemble import RandomForestClassifier  # Random Forest sınıflandırıcıyı içe aktarma
from sklearn.metrics import classification_report
from sklearn.pipeline import Pipeline
from nltk.tokenize import word_tokenize  # Kelime ayırma için gerekli
from nltk.corpus import stopwords  # Stopwords'leri kaldırmak için
import nltk

# Türkçe stopword'lerini yükle
nltk.download('stopwords')
nltk.download('punkt')
stopwords = set(stopwords.words('turkish'))

# Veri setini yükle
train_df = pd.read_csv('C:/Users/burakk/PycharmProjects/bitirme-projesi/datasets/train.csv',nrows=10000)
test_df = pd.read_csv('C:/Users/burakk/PycharmProjects/bitirme-projesi/datasets/test.csv',nrows=10000)
...
model_pipeline = Pipeline([
    ...
    ('clf', RandomForestClassifier(n_estimators=100, random_state=42))  # Random Forest kullanımı
])
